...
int ei_main(int argc, char** argv)
{
        ...
        *conversation_min_size = ei_size(50,50);
        ...
        radiobutton = ei_widget_create("radiobutton", conversation);
        button_green = ei_widget_create("button", conversation);
        button_red = ei_widget_create("button", conversation);
        ...
        ei_grid(button_green, &button_green_lin, &button_green_col, &button_green_w, NULL, NULL, 
                        NULL);
